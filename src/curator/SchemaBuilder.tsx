  ...
  return (
    <div className="border-2 mt-12 px-12 py-8">
      <div>
        ...
        <div className="mt-2">
          <button
            onClick={addNewBlankAttribute}
            className="border-2 mt-4 w-max px-4 py-4 cursor-pointer hover:bg-indigo-600 hover:text-white>
      ...
      <div>
        <button
          onClick={() => updateHandler(workingSchema)}
        ...
        <button
          onClick={() => updateHandler(schema)}
          className="border-2 mt-6 ml-4 w-max px-4 py-4 cursor-pointer hover:bg-red-600 hover:text-white
        text-center font-semibold"
        >
          EXIT WITHOUT SAVING
        </button>
  ...
  return (
    <div>
      <div className="flex mt-2">
        ...
        <div
          onClick={addOption} // fix the styling on this
